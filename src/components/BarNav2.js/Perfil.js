...
const imgP = `https://server-ofrecetusservicios.onrender.com/public/uploads/`
...
const handleSubmitImage = () => {
  ...
  fetch(`https://server-ofrecetusservicios.onrender.com/enviarImagen/${usuarioPresente.id}`, {
    method: 'POST',
    body: formData
  })
...
const ruta = `https://server-ofrecetusservicios.onrender.com/public/uploads/${imagenUsuario}`
